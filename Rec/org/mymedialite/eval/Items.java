...
public class Items {
  ...
  public static ItemRecommendationEvaluationResults evaluate(
    ...
    for (Integer user_id : test_users) {
      ...
      // TODO this is a modification
      // Start with a random order of items
      List<Integer> randomItems = Extensions.predictItems(new Random(), user_id, candidate_items);
      List<Integer> prediction_list = Extensions.predictItems(recommender, user_id, randomItems);
  ...
  private static void printStatus(int completedFutures){
	  if (completedFutures % 1000 == 0)
		  System.out.print(".");
	  if (completedFutures % 60000 == 0)
		  System.out.println();
  }
